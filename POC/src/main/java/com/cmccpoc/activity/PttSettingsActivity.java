...
public class PttSettingsActivity extends BaseActivity implements AdapterView.OnItemClickListener {
    private ListView mPttSettingsLv;
    private ArrayList<String> mList=new ArrayList<String>();
    private int mData[]={R.string.talk_tools_location,R.string.heart_settings};
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        switch (position){
            case 0:
                intent.setClass(PttSettingsActivity.this,MenuGpsActivity.class);
                startActivity(intent);

                break;
            case 1:
                intent.setClass(PttSettingsActivity.this,MenuSettingPttActivity.class);
                startActivity(intent);
                /*mPopSettings=new PopupMenu(this,view);
                getMenuInflater().inflate(R.menu.heart_beat_menu,mPopSettings.getMenu());*/
                break;
        }
    }
