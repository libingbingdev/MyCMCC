...
public class PttSettingsAdapter extends BaseAdapter{
    Context mContext;
    ArrayList<String> mList;
    public PttSettingsAdapter(Context context, ArrayList<String> list){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null)
        {
            view = LayoutInflater.from(mContext).inflate(R.layout.ptt_settings_item_layout, null);
